...
namespace Fraple7
{
	namespace Core
	{
		...
		public:
			...
			static void Allocate(const ComPtr<ID3D12Device2>& device, Buffer& buffer, size_t size, D3D12_HEAP_TYPE type, D3D12_RESOURCE_STATES state, D3D12_HEAP_FLAGS flags = D3D12_HEAP_FLAG_NONE)
			{
